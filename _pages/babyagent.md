...
permalink: /babyagent/
title: BabyAgent
description: Self-supervised Learning beyond Internet Data.
nav: false
nav_order: 4
---
...
continuously capture real-world scenes. *Figure B.1* shows at the center of the photo
...
the world easily. Three examples of acquired images are presented in *Figure B.2*.
...
is depicted in *Figure B.3*. As for [[2]](#2), the training procedure includes a network
...
as shown in *Figure B.4*. We randomly select one of the heads, and then we fit a
...
**Table B.1**: *BabyAgent learning progression over a temporal window of 10 days. A linear
classifier is learned on top of frozen features for some control datasets.*
...
In *Table B.1* and *Table B.2* are reported the preliminary results for the linear
...
results have an average standard deviation of $σ=0.01$.
...
**Table B.2**: *BabyAgent learning progression over a temporal window of 10 days. A
...
the $k$ nearest stored features, and it votes for the label.*
...
<a id="6">[6]</a> 
Loshchilov, I., & Hutter, F. (2017). Fixing weight decay regularization in adam. arXiv preprint arXiv:1711.05101, 5, 5.
